      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
              ...
              <h2><asp:Label ID="Label1" runat="server" Text="Terms And Condition"></asp:Label></h2>
              <ol class="breadcrumb">
...
<section id="about">
    <div class="container" >
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="about-area" style="margin-top: -25px;">
            <div class="row">
           <%--  <h6 class="tittle" style="padding-bottom: 12px;"> <span><asp:Label ID="Label5" runat="server" Text=""></asp:Label></span> Terms and Condition</h6>
           --%>          
              <div class=" col-xs-12">
                  ...
                  <div class="title-area">
                    ...
                    <h3 style="color:Red;"> Introduction</h3>
                      <p class="style2" style="mso-list: l0 level1 lfo1">
                          ...
                          </span><![endif]><span>The Site is operated by "Connected Skills" ("we" or "us") and its membership is open to any individual who chooses to register with the site.
                          </br>
These terms will apply to anyone who views or uses the site ("you").</br></br>
...
Please note that these terms and conditions may be amended from time to time. Notification of any changes will be made by posting new terms onto the Site. In continuing to use the site you confirm that you accept the then current terms and conditions in full at the time you use the site.<o:p></o:p></span></p>
                </div>
                <div class="title-area">
                    <h3 style="color:Red;">Registration</h3>
                      <p class="style2" style="mso-list: l0 level1 lfo1">
                          <![if !supportLists]><span>
                          </span><![endif]><span>Registration with the site is currently free, however in order to become a registered user you will have to provide some basic personal information.
                          </br></br>
You agree that all information supplied on registration is true and accurate and will be kept up to date at all times. We will use the information provided to us to contact you.</br></br>
...
You are not entitled to allow any other person to use your registration. You may not impersonate any other person in any registration whether or not that other person is a user of the site.
 ...
 On receipt of an email by you to us cancelling your registration then we will terminate your registration.</br></br>
 We reserve the right to terminate your registration immediately without notice if in our opinion you have breached these terms.</br></br>
...
<o:p></o:p></span></p>
                ...
                <div class="title-area">
                    ...
                    <h3 style="color:Red;">Use and Abuse of the Site</h3>
                      <p class="style2" style="mso-list: l0 level1 lfo1">
                          <![if !supportLists]><span>
                          </span><![endif]><span>You agree that any information you supply will be true and accurate.
                          </br></br>
...
<o:p></o:p></span></p>
                ...
                <div class="title-area">
                    ...
                    <h3 style="color:Red;">Advertising and Commercial Use</h3>
                      <p class="style2" style="mso-list: l0 level1 lfo1">
                          <![if !supportLists]><span>
                          </span><![endif]><span>Users of the Site are not entitled to directly advertise to or solicit the custom of other users without our express written consent.
                          </br></br>
...
We request that all information provided to us is accurate, current and complete. </br></br>
...
<o:p></o:p></span></p>
                ...
                <div class="title-area">
                    ...
                    <h3 style="color:Red;">Other Sites and Linking</h3>
                      <p class="style2" style="mso-list: l0 level1 lfo1">
                          <![if !supportLists]><span>
                          </span><![endif]><span>
