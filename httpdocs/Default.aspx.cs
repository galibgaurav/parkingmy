...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count == 1)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, typeof(string), "Alert", ";$('#myModalTitle').text('Login Error !');$('#myModalMessage').text('Invalid Login.');$('#loginFormID').css('display','none');document.getElementById('btnError').click();", true);
            }
        }
        else
        {

            ScriptManager.RegisterStartupScript(this, typeof(string), "Alert", "$('#myModalTitle').text('Login Error !');$('#myModalMessage').text('Email Id or Password Incorrect.');$('#loginFormID').css('display','none');document.getElementById('btnError').click();", true);
            ...
            //ScriptManager.RegisterStartupScript(this, typeof(string), "Alert", "document.getElementById('dialogBtn').click();", true);
        }
    ...
    private void GetAvailableParkingSpaceID(string lat, string longt)
    {
        ...
        SqlCommand con = new SqlCommand("SELECT Id FROM(SELECT *,(((acos(sin((@lat*pi()/180)) * sin((lat*pi()/180))+cos((@lat*pi()/180)) * cos((lat*pi()/180)) * cos(((@longt - longt)*pi()/180))))*180/pi())*60*1.1515*1.609344) as distance FROM Admin_Rent_Space) t WHERE distance <=3", sconn);
